...
const $$Signup = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`${renderComponent($$result, "Layout", $$Layout, { "title": "Create Account - PDFManager" }, { "default": ($$result2) => renderTemplate` ${renderComponent($$result2, "AuthForm", $$AuthForm, { "type": "signup", "title": "Create your account", "subtitle": "Start managing your PDFs today" })} ` })}`;
